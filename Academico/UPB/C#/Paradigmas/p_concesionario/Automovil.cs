...
namespace p_Concesionario
{
    public class Automovil
    {
        ...
        //Atributos de validacion de reglas
        ...
        public string Placa { get => placa; 
            ...
            value.Substring(0, 2).ToCharArray().Any(c => !char.IsLetter(c))) || value.Substring(3, 2).ToCharArray().Any(c => !char.IsNumber(c))) ? value : throw new Exception("Formato de la placa No Válido"); 
