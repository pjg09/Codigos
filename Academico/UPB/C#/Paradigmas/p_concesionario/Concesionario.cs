...
namespace p_Concesionario
{
    public class Concesionario
    {
        ...
        //public bool Vender_Auto(string placa) Este metodo busca el auto que le dan como parametro en la lista l_automovil y si lo encuentra lo saca de esa lista y lo pone en la lista de vendidos
